...
sys.path.append("/data/home/red-hot-chili-pepper/.local/share/PackageManager/apps/caresses/otherlibs/")
...
class CARESSES(object):
    ...
    def run(self):
        self.animated_speech.say("Application started!", self.configuration)
        ...
        while self.isAlive:
            ...
            while True:
                ...
                if reco_speech:
                    sentence = sentence + sep + reco_speech[0][0].decode('utf-8')
